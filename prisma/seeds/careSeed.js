...
exports.seedCareModules = seedCareModules;
const client_1 = require("@prisma/client");
const careModules = [
    {
        title: "Handling child's behavior",
        subtitle: 'Understanding emotional regulation and response strategies',
        description: 'Learn calm, practical ways to respond to tantrums, limits, and big feelings.',
        coverImageUrl: 'https://images.unsplash.com/photo-1543269865-cbf427effbad?q=80&w=1200&auto=format&fit=crop',
        category: client_1.CareModuleCategory.CHILD_DEVELOPMENT,
        ageGroup: '0-6 months',
        estimatedMinutes: 130,
        coinReward: 15,
        keyTakeaway: 'Behavior is communication. Respond to the need before correcting the action.',
        contentSections: [
            {
        ...
        questions: [
            {
                ...
                explanation: 'A calm adult response helps the child co-regulate before problem-solving can happen.',
                options: [
            ...
            },
            {
                ...
                explanation: 'Children often show unmet needs through behavior before they can explain them clearly.',
                options: ['True', 'False'],
                correctIndex: 0,
            },
            {
                question: 'Which response supports healthy boundaries?',
                explanation: 'Gentle, clear, repeated limits help children feel secure while learning expectations.',
                options: [
            ...
            },
            {
                ...
                explanation: 'Small choices give children a sense of agency without removing the caregiver boundary.',
                options: [
            ...
            },
            {
                ...
                explanation: 'Repair and reconnection teach safety and reflection after emotional stress.',
    ...
    },
    {
        ...
        description: 'Support healthy feeding with safe textures, steady routines, and responsive cues.',
        coverImageUrl: 'https://images.unsplash.com/photo-1555252333-9f8e92e65df9?q=80&w=1200&auto=format&fit=crop',
        category: client_1.CareModuleCategory.NUTRITION_FEEDING,
        ageGroup: '6-12 months',
        estimatedMinutes: 113,
        coinReward: 15,
        keyTakeaway: 'Responsive feeding follows the child cues while keeping safety and routine consistent.',
        contentSections: [
            {
                heading: 'Real-life situation',
        ...
        questions: [
            {
                ...
                explanation: 'An upright position supports swallowing and reduces choking risk.',
                options: ['Lying down', 'Upright and supported', 'Walking around'],
                correctIndex: 1,
            },
            {
                question: 'Responsive feeding means watching child cues.',
                explanation: 'Caregivers should notice hunger, fullness, interest, and refusal cues.',
                options: ['True', 'False'],
                correctIndex: 0,
            },
            {
                question: 'What is a good mealtime approach?',
                explanation: 'Calm, low-pressure meals help children build trust around food.',
    ...
    },
    {
        ...
        description: 'Create nap and bedtime routines that help children settle with less stress.',
        coverImageUrl: 'https://images.unsplash.com/photo-1519689680058-324335c77eba?q=80&w=1200&auto=format&fit=crop',
        category: client_1.CareModuleCategory.SLEEP_ROUTINES,
        estimatedMinutes: 75,
        coinReward: 10,
        keyTakeaway: 'Predictable routines help children know what comes next and settle more easily.',
        contentSections: [
            {
                heading: 'Care response',
                bullets: [
        ...
        questions: [
            {
                ...
                explanation: 'Predictable steps reduce uncertainty and support regulation.',
    ...
    },
    {
        ...
        description: 'Spot common home hazards and build safer supervision habits.',
        coverImageUrl: 'https://images.unsplash.com/photo-1503454537195-1dcabb73ffb9?q=80&w=1200&auto=format&fit=crop',
        category: client_1.CareModuleCategory.CHILD_SAFETY,
        ageGroup: '2-4 years',
        estimatedMinutes: 60,
        coinReward: 10,
        keyTakeaway: 'Safe spaces are prepared before play starts, not only after risk appears.',
        contentSections: [
            {
                heading: 'Safety scan',
                bullets: [
        ...
        questions: [
            {
                ...
                explanation: 'A quick scan before play prevents many common accidents.',
    ...
    },
    {
        ...
        description: 'Prepare for minor cuts, bumps, choking risks, and when to call for help.',
        coverImageUrl: 'https://images.unsplash.com/photo-1584515933487-779824d29309?q=80&w=1200&auto=format&fit=crop',
        category: client_1.CareModuleCategory.FIRST_AID,
        ageGroup: '4 years +',
        estimatedMinutes: 95,
        coinReward: 15,
        keyTakeaway: 'Prepared caregivers respond faster and escalate when symptoms are serious.',
        contentSections: [
            {
                heading: 'Care response',
                bullets: [
        ...
        questions: [
            {
                ...
                explanation: 'Emergency contacts and child health notes support fast decisions.',
    ...
    },
    {
        ...
        description: 'Use play to support language, movement, creativity, and connection.',
        coverImageUrl: 'https://images.unsplash.com/photo-1503919545889-aef636e10ad4?q=80&w=1200&auto=format&fit=crop',
        category: client_1.CareModuleCategory.PLAY_LEARNING,
        estimatedMinutes: 80,
        coinReward: 10,
        keyTakeaway: 'Simple shared play can build attention, communication, and confidence.',
        contentSections: [
            {
                heading: 'Care response',
                bullets: [
        ...
        questions: [
            {
                ...
                explanation: 'Following the child interest increases engagement and learning.',
    ...
    },
    {
        ...
        description: 'Keep parents informed with useful updates about routines, meals, mood, and concerns.',
        coverImageUrl: 'https://images.unsplash.com/photo-1529156069898-49953e39b3ac?q=80&w=1200&auto=format&fit=crop',
        category: client_1.CareModuleCategory.COMMUNICATION,
        ageGroup: '6-12 months',
        estimatedMinutes: 55,
        coinReward: 10,
        keyTakeaway: 'Useful updates are specific, calm, timely, and focused on the child.',
        contentSections: [
            {
                heading: 'Care response',
                bullets: [
        ...
        questions: [
            {
                ...
                explanation: 'Specific facts help parents understand the child day clearly.',
    ...
    },
    {
        ...
        description: 'Build handwashing, diapering, toileting, and illness-prevention routines.',
        coverImageUrl: 'https://images.unsplash.com/photo-1584744982491-665216d95f8b?q=80&w=1200&auto=format&fit=crop',
        category: client_1.CareModuleCategory.HEALTH_HYGIENE,
        ageGroup: '12-24 months',
        estimatedMinutes: 65,
        coinReward: 10,
        keyTakeaway: 'Repeated hygiene routines become easier when they are predictable and calm.',
        contentSections: [
            {
                heading: 'Care response',
                bullets: [
        ...
        questions: [
            {
                ...
                explanation: 'Handwashing before meals reduces germ spread and supports healthy routines.',
    ...
    },
    {
        ...
        description: 'Help children separate, settle, and begin routines with confidence.',
        coverImageUrl: 'https://images.unsplash.com/photo-1516627145497-ae6968895b74?q=80&w=1200&auto=format&fit=crop',
        category: client_1.CareModuleCategory.SLEEP_ROUTINES,
        estimatedMinutes: 45,
        coinReward: 8,
        keyTakeaway: 'A warm, predictable handoff can reduce stress for both child and caregiver.',
        contentSections: [
            {
                heading: 'Care response',
                bullets: [
        ...
        questions: [
            {
                ...
                explanation: 'Predictability and warmth help children settle into the day.',
    ...
    },
    {
        ...
        description: 'Respond to food refusal with patience, structure, and repeated exposure.',
        coverImageUrl: 'https://images.unsplash.com/photo-1478145046317-39f10e56b5e9?q=80&w=1200&auto=format&fit=crop',
        category: client_1.CareModuleCategory.NUTRITION_FEEDING,
        ageGroup: '4 years +',
        estimatedMinutes: 70,
        coinReward: 10,
        keyTakeaway: 'Repeated low-pressure exposure works better than forcing bites.',
        contentSections: [
            {
                heading: 'Care response',
                bullets: [
        ...
        questions: [
            {
                ...
                explanation: 'Low-pressure exposure builds familiarity and trust over time.',
    ...
    },
    {
        ...
        description: 'Prepare for outdoor play with supervision, sun care, hydration, and boundaries.',
        coverImageUrl: 'https://images.unsplash.com/photo-1596464716127-f2a82984de30?q=80&w=1200&auto=format&fit=crop',
        category: client_1.CareModuleCategory.CHILD_SAFETY,
        ageGroup: '0-6 months',
        estimatedMinutes: 50,
        coinReward: 8,
        keyTakeaway: 'Outdoor safety starts with clear boundaries and active supervision.',
        contentSections: [
            {
                heading: 'Care response',
                bullets: [
        ...
        questions: [
            {
                ...
                explanation: 'Active supervision means watching and staying close enough to respond.',
    ...
    },
    {
        ...
        description: 'Use meals, dressing, play, and cleanup as natural language moments.',
        coverImageUrl: 'https://images.unsplash.com/photo-1484820540004-14229fe36ca4?q=80&w=1200&auto=format&fit=crop',
        category: client_1.CareModuleCategory.COMMUNICATION,
        estimatedMinutes: 60,
        coinReward: 10,
        keyTakeaway: 'Narrating care routines helps children connect words with real experiences.',
        contentSections: [
            {
                heading: 'Care response',
                bullets: [
        ...
        questions: [
            {
                ...
                explanation: 'Simple narration connects words to actions and objects.',
    ...
    },
    {
        ...
        description: 'Understand toileting readiness and create calm, respectful routines.',
        coverImageUrl: 'https://images.unsplash.com/photo-1595454038955-4d80d06358b2?q=80&w=1200&auto=format&fit=crop',
        category: client_1.CareModuleCategory.HEALTH_HYGIENE,
        ageGroup: '12-24 months',
        estimatedMinutes: 65,
        coinReward: 10,
        keyTakeaway: 'Toileting progress is easier when caregivers follow readiness, not pressure.',
        contentSections: [
            {
                heading: 'Care response',
                bullets: [
        ...
        questions: [
            {
                ...
                explanation: 'Readiness signs help caregivers support progress without stress.',
    ...
    },
    {
        ...
        description: 'Strengthen the care relationship with reliability, boundaries, and thoughtful communication.',
        coverImageUrl: 'https://images.unsplash.com/photo-1521791136064-7986c2920216?q=80&w=1200&auto=format&fit=crop',
        category: client_1.CareModuleCategory.OTHER,
        ageGroup: '2-4 years',
        estimatedMinutes: 50,
        coinReward: 8,
        keyTakeaway: 'Professional care is warm, reliable, respectful, and well-communicated.',
        contentSections: [
            {
                heading: 'Care response',
                bullets: [
        ...
        questions: [
            {
                ...
                explanation: 'Reliability and respectful communication help families feel secure.',
...
async function seedCareModules(prisma) {
    ...
    for (const moduleSeed of careModules) {
        ...
        const moduleData = {
            ...
            isPublished: true,
            adminStatus: client_1.CareModuleAdminStatus.PUBLISHED,
        };
            ...
            await prisma.careQuizQuestion.createMany({
                data: moduleSeed.questions.map((question, questionIndex) => ({
                    ...
                    type: question.options.length === 2
                        ? client_1.CareQuestionType.TRUE_FALSE
                        : client_1.CareQuestionType.SINGLE_CHOICE,
...
function questionCreates(moduleSeed) {
...
async function seedSampleCareAssignments(prisma, modules) {
    ...
    await Promise.all(modules.map((module, index) => prisma.careModuleProgress.upsert({
        where: {
            moduleId_userId: {
                moduleId: module.id,
                userId: nanny.id,
    ...
    await Promise.all(modules.slice(0, 3).flatMap((module) => [
...
async function seedCareInsightActivities(prisma, input) {
    const plan = await prisma.dayPlan.upsert({
        ...
        update: {
            mode: client_1.DayPlanBuildMode.MANUAL,
            status: client_1.DayPlanStatus.READY,
    ...
    const activities = [
        {
            ...
            enjoyment: client_1.TaskEnjoymentLevel.LOVE_IT,
            childMood: client_1.ChildMood.HAPPY,
            completionRate: client_1.TaskCompletionRate.FULL_PLATE,
            sortOrder: 1,
        },
        {
            ...
            enjoyment: client_1.TaskEnjoymentLevel.ENJOY_IT,
            childMood: client_1.ChildMood.EXCITED,
            completionRate: client_1.TaskCompletionRate.FULL_PLATE,
            sortOrder: 2,
        },
        {
    ...
    for (const seed of activities) {
        ...
        const mediaAsset = existingMedia ??
    ...
    console.log(`Care insight activities seeded for ${input.childName}: ${activities.length}`);
}
function assignmentData(index) {
    if (index >= 10) {
        return {
            status: client_1.CareModuleProgressStatus.COMPLETED,
    ...
    return {
        status: client_1.CareModuleProgressStatus.IN_PROGRESS,
        startedAt: new Date('2026-08-08T02:30:00.000Z'),
...
//# sourceMappingURL=careSeed.js.map