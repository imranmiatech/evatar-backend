    ...
    const activitiesData = [
        {
            ...
            activityType: client_1.ActivityType.OUTDOOR_PLAY,
            minAgeMonths: 36,
            maxAgeMonths: 96,
            durationMin: 10,
            durationMax: 20,
            energyLevel: client_1.EnergyLevel.MEDIUM_HIGH,
            location: [client_1.ActivityLocation.INDOOR, client_1.ActivityLocation.OUTDOOR, client_1.ActivityLocation.GROUP],
        ...
        },
        {
            ...
            activityType: client_1.ActivityType.LEARNING_DEVELOPMENT,
            minAgeMonths: 12,
            maxAgeMonths: 36,
            durationMin: 15,
            durationMax: 30,
            energyLevel: client_1.EnergyLevel.LOW,
            location: [client_1.ActivityLocation.INDOOR],
        ...
        },
        {
            ...
            activityType: client_1.ActivityType.STORY_TIME,
            minAgeMonths: 36,
            maxAgeMonths: 84,
            durationMin: 15,
            durationMax: 30,
        ...
        },
        {
            ...
            activityType: client_1.ActivityType.ART,
            minAgeMonths: 24,
            maxAgeMonths: 72,
            durationMin: 20,
            durationMax: 40,
            energyLevel: client_1.EnergyLevel.MEDIUM,
            location: [client_1.ActivityLocation.OUTDOOR, client_1.ActivityLocation.INDOOR],
        ...
        },
        {
            ...
            activityType: client_1.ActivityType.MUSIC,
            minAgeMonths: 12,
            maxAgeMonths: 48,
            durationMin: 10,
            durationMax: 20,
        ...
        },
        {
            ...
            durationMax: 30,
            energyLevel: client_1.EnergyLevel.LOW,
            location: [client_1.ActivityLocation.INDOOR, client_1.ActivityLocation.OUTDOOR],
        ...
        },
        {
            ...
            activityType: client_1.ActivityType.CREATIVE_PLAY,
            minAgeMonths: 36,
            maxAgeMonths: 84,
            durationMin: 20,
            durationMax: 45,
...
//# sourceMappingURL=activitySeed.js.map